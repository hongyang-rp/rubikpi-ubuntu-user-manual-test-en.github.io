...
:::note
  ...
  * To enable audio, please refer to [Audio](../2.Peripherals%20and%20Interfaces/7.%20Audio.md).
::: 
...
1. Install the camera-related software.
   ...
   2. Install the camera software.
       ...
       sudo echo  enableNCSService=FALSE >> /var/cache/camera/camxoverridesettings.txt
       ```
