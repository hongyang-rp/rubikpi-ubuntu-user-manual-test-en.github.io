...
1. Click to download the compressed package of model files and label files required for the sample application *ai\_sample\_app\_model\_label.zip*.
...
* Push the necessary model files and label files from the model compression package to the */opt* directory:
