...
| **Aspect**               |  [🖥️ Device with Preloaded Certified Ubuntu Build (Post 9/30)](http://localhost:3002/rubikpi-ubuntu-user-manual-test-en.github.io/docs/Document%20Home/Dogfooding-Guide#workflow-1--device-with-preloaded-certified-ubuntu-build-post-930) |  [🖥️Workflow 2 – Preloaded QLI Build (Pre 9/30)](http://localhost:3002/rubikpi-ubuntu-user-manual-test-en.github.io/docs/Document%20Home/Dogfooding-Guide#workflow-2--user-gets-a-device-with-preloaded-qli-build--pre-930) | [🖥️Workflow 3 – QLI/Android to Certified Ubuntu (Post 9/30)](http://localhost:3002/rubikpi-ubuntu-user-manual-test-en.github.io/docs/Document%20Home/Dogfooding-Guide#workflow-3--workflow-3-user-device-is-preloaded-to-qliandroid-build-and-update-to-certified-canonical-ubuntu-build-post-930) |  [🖥️Workflow 4 – Reset System Image or Update Qcom Firmware](http://localhost:3002/rubikpi-ubuntu-user-manual-test-en.github.io/docs/Document%20Home/Dogfooding-Guide#workflow-4-user-wants-to-reset-the-system-image-or-update-qcom-firmware) |
|--------------------------|---------------------------------------------------------------|--------------------------------------------------|---------------------------------------------------------------|--------------------------------------------------------------|
...
<TabItem value="Workflow1" label="Workflow1-Preloaded Certified Build(Post 9/30)">
	...
	###### Reference: [🔗 Wi-Fi Setup Guide](https://hongyang-rp.github.io/rubikpi-ubuntu-user-manual-test-en.github.io/docs/Document%20Home/quick-start/set-up-your-device#connect-to-the-network)
	...
	###### Commands:  
	```shell
	wget https://github.com/rubikpi-ai/rubikpi-script/blob/ubuntu_setup/install_ppa_pkgs.sh
...
###### Reference: [🔗Flash using the QDL tool](http://localhost:3002/rubikpi-ubuntu-user-manual-test-en.github.io/docs/Document%20Home/Troubleshooting/update-software-advanced#flash-using-the-qdl-tool)  
...
unzip the folder
###### Reference: [🔗Canonical link](https://oem-share.canonical.com/partners/tangshan/share/ubuntu-server-24.04/20250912-127/tangshan-ubuntu-server-24.04-20250912-127.tar.xz) , [🔗Dropbox location](\\lab9101\Dropbox\UBUNTU\Rubik-Pi\tangshan-ubuntu-server-24.04-20250729-19\tangshan-ubuntu-server-24.04-20250729-19 )
...
Login and change password on the monitor terminal (SBC). 
Set up Wi-Fi connectivity.  
###### Reference: [🔗 Wi-Fi Setup Guide](https://hongyang-rp.github.io/rubikpi-ubuntu-user-manual-test-en.github.io/docs/Document%20Home/quick-start)
...
wget https://github.com/rubikpi-ai/rubikpi-script/blob/ubuntu_setup/install_ppa_pkgs.sh
chmod +x install_ppa_pkgs.sh
a.	git clone -b ubuntu_setup --single-branch https://github.com/rubikpi-ai/rubikpi-script.git; cd rubikpi-script; chmod +x install_ppa_pkgs.sh; ./install_ppa_pkgs.sh 
```
