...
wget https://github.com/rubikpi-ai/rubikpi-script/blob/ubuntu_setup/install_ppa_pkgs.sh
chmod +x install_ppa_pkgs.sh
git clone -b ubuntu_setup --single-branch https://github.com/rubikpi-ai/rubikpi-script.git; cd rubikpi-script; chmod +x install_ppa_pkgs.sh; ./install_ppa_pkgs.sh 
```
