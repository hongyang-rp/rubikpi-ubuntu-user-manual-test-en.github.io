...
### How can I configure Universal Flash Storage (UFS)?
  ...
  * Refer to [Flash using the QDL tool.](../3.Update-Software/3.2.flash-over-android.md#flashQDL)

### How can I force the device into Emergency Download (EDL) mode?

  * Refer to [Enter EDL mode.](../2.set-up-your-device.md#enterEDL)
...
<a id="how-do-i-exit-fastboot-mode-on-the-rubik-pi-3"></a>
