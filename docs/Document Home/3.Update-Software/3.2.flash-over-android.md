...
#  Flash Canonical Ubuntu 24.04 Over Android/QLI Build
	...
	:::info 
		...
		- **Before You Start** - Complete [**🔗setup**](../3.Device%20Setup/set-up-your-device.md) instructions.  
	:::
	---
...
Provisioning ensures that the Universal Flash Storage (UFS) is correctly initialized and partitioned to support the new OS image.  
	...
	2: Unzip and copy the QDL executable files from [**Step1**](#1️⃣-setup-qdl-tool) to UFS provision folder.  
	:::note
		- For Windows host make sure to copy the dll files along with the executable.
	:::
3: Enter into [**🔗 EDL mode**](../3.Device%20Setup/set-up-your-device.md#enterEDL)  
...
1: Download the file  [**🔗Renesas FW Update**](https://thundercomm.s3.dualstack.ap-northeast-1.amazonaws.com/uploads/web/rubik-pi-3/firmware/Flat_usb_fw.zip)  
	2: Unzip and copy the QDL executable files from [**Step1**](#1️⃣-setup-qdl-tool) to Renesas Firmware folder.  
	:::note
		- For Windows host make sure to copy the dll files along with the executable
	:::
3: Enter into [**🔗 EDL mode**](../3.Device%20Setup/set-up-your-device.md#enterEDL)   
...
6: Unzip and copy the QDL executable files from [**Step1**](#1️⃣-setup-qdl-tool) to Boot Firmware folder.  
	:::note
		- For Windows host make sure to copy the dll files along with the executable
	:::
7: Enter into [**🔗 EDL mode**](../3.Device%20Setup/set-up-your-device.md#enterEDL)   
...
2: Set up Wi-Fi connectivity.  [🔗 Wi-Fi Setup Guide](../3.Device%20Setup/set-up-your-device.md#conNET)
...
---
> **🧭 Next Steps**
> After the image is flashed, refer to the [**Application Development and Execution Guide**](../5.Application%20Development%20and%20Execution%20Guide/1.Building%20AI%20Models/1.edge_impulse.md).
---