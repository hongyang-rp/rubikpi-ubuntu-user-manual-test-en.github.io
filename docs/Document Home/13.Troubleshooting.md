...
### Fan
  ...
  RUBIK Pi 3 does not come with a fan. In scenarios with high computational demands, it is recommended that you purchase and install a fan. For details, refer to the [Accessories](./1.%20Quick%20Start/1.Accessories.md) section.
...
### How can I flash the Configuration Data Table (CDT)?
  ...
  Ensure that the device is in EDL mode. For more information, refer to [Enter EDL mode.](1.%20Quick%20Start/2.Update%20software.md#enterEDL)
  :::
