...
2. Set up your RUBIK Pi with Wi-Fi and SSH enabled. Instructions for this set up can be found [here](./Document%20Home/2.Device%20Setup/set-up-your-device.md). 
