...
:::note
  ...
  * To view the display output, connect an HDMI display to the HDMI port of RUBIK Pi 3 by referring to [Connect an HDMI display](./Document%20Home/2.Device%20Setup/set-up-your-device.md#conHDMI).
