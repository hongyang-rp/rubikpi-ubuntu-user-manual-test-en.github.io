...
:::note
  ...
  * To view the display output, connect an HDMI display to the HDMI port of RUBIK Pi 3 by referring to [Connect an HDMI display](,/Document\ Home/1.quick-start/2.set-up-your-device.md#conHDMI).
