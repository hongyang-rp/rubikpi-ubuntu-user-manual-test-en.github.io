...
:::note
  ...
  * To view the display output, connect an HDMI display to the HDMI port of RUBIK Pi 3 by referring to [Connect an HDMI display](./Document%20Home/3.Device%20Setup/set-up-your-device.md#conHDMI).
...
4. To test the graphics, run the sample application. The following example runs the Weston-simple-egl:
   ...
   ![](./Document%20Home/images/image-12.jpg)
...
![](./Document%20Home/images/image-13.jpg)
...
![](./Document%20Home/images/image-14.jpg)
...
![](./Document%20Home/images/image-15.jpg)
...
![](./Document%20Home/images/image-16.jpg)
...
![](./Document%20Home/images/image-17.jpg)
